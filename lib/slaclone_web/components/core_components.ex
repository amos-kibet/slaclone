defmodule SlacloneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SlacloneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SlacloneWeb.Gettext, "errors", msg, opts)
    end
  end
